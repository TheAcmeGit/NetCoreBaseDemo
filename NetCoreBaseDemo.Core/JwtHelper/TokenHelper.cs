...
namespace NetCoreBaseDemo.Core.JwtHelper
{
    /// <summary>
    /// 生成JWT字符串
    /// </summary>
    ...
    {
        // 密钥，注意不能太短
        public static string secretKey { get; set; } = "75bda61fe5bf4c3f86d5dd94bbb58128";
        /// <summary>
        /// 生成JWT字符串
        /// </summary>
        ...
        public static string GetJWT(TokenModel tokenModel)
        {
            ...
            var claims = new List<Claim>
            {
                new Claim(JwtRegisteredClaimNames.Jti,tokenModel.ID.ToString()),
                  new Claim(JwtRegisteredClaimNames.UniqueName,tokenModel.ID.ToString()),
                // 令牌颁发时间
